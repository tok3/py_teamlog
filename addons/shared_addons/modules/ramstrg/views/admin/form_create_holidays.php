...
<section class="title">
	<h4><?php echo lang('ramstrg:holidays') . ' ' . lang('ramstrg:add'); ?></h4>
</section>
...
<section class="item">
	<div class="content">
		...
		echo form_open_multipart(site_url('admin/ramstrg/insertBusinessHolidays'), 'class="crud" id="businessHours"', $hidden ); 
		?>
